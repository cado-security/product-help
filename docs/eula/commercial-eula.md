...
Customer acknowledges and agrees that (a) the Software is delivered to Customer and exclusively installed within Customer’s environment, and (b) Company does not host the Software, nor host, collect or process Company or its Users’ data as part of Customer’s intended and permitted use.  As per clause 12, You agree that Company and its affiliates may freely collect and use certain Software use and technical information which is acquired by Company as part of Customer’s use of the Software. Company uses this information to generate data on the use of the Software for research and to drive improvements in the Software. Company agrees not to publish any of this information in a form that personally identifies Customer. In the event Company processes personal data as a processor, such personal data will be processed by Company in accordance with applicable data protection laws.
