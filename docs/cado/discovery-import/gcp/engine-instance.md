...
- [Cross Project Service Accounts on Google Cloud](https://blog.salrashid.dev/articles/2021/cross_project_svc_account/)
- [Service account impersonation](https://docs.cloud.google.com/iam/docs/service-account-impersonation#enabling-cross-project)
- [Grant required roles to the Cloud Build service account](https://docs.cloud.google.com/compute/docs/import/requirements-export-import-images#required-roles-cloud-build-sa)
