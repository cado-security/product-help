...
2. **Direct Download**: Download and run Cado Host independently without interacting with the Platform.
...
1. In the / Forensic Acquisition and Investigation Platform, go to **Investigation > Import > Cado Host**.
