...
* Create a new Cado IAM role with the [permissions listed here](/cado/deploy/gcp/gcp-settings#creating-a-cado-role.).
...
[here](/cado/deploy/gcp/gcp-settings#getting-gcp-credentials) & [here](/cado/deploy/gcp/gcp-settings#entering-settings)
* To allow access to your other GCP projects, follow the [Cado documentation](/cado/deploy/gcp/gcp-cross-project) for each other GCP project.
