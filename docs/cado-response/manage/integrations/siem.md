...
See [here](/cado-response/discovery-import/data-types/logs#log-analysis-considerations) for content contrasting SIEM tools relative to Cado's capabilities.
