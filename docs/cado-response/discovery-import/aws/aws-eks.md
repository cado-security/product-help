...
:::info
You should use the role ARN added in the [Cross Account Creation](/cado-response/deploy/aws/iam/cross-account-creation.md#step-2-add-target-aws-role-arn-to-the-cado-platform) that relates to the AWS Account ID where the cluster resides.
:::
