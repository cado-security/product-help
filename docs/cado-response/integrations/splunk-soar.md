...
Below are the instructions for setting up the Cado Response and SOAR integration:
...
- The Cado Response Splunk SOAR App tarball available for download **[here](https://cado-public-access.s3.amazonaws.com/phantom-integration/phantom_cadoresponse_0-9-0.tgz)**
