...
### Can I allow or restrict IPs/ranges from accessing our Cado Response instance?
Yes, and it is recommended to restrict access to only those IPs which require access.  Navigate to your **[AWS EC2 Console](https://console.aws.amazon.com/ec2)**, click on your Cado Instance ID, navigate to the Security tab, then click on the "Security Group" link, then "Edit Inbound Rules". Here you can add and remove access rules for the Cado Reponse instance. 
