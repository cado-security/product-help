...
Please see the [guide on how to add cross-account access](iam/cross-account-creation.md)

### How to Tighten IAM, Other Permissions and Logging Best Practices
Please see the [guide on AWS IAM Considerations](iam/deployment-iam-considerations.md) and the [guide on logging best practices](logging.md)

### How to Perform Backup and Recovery
Please see the [guide on AWS Backup and Recovery](performance-resiliency/aws-backups.md)
